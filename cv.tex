...
\begin{tikzpicture}[remember picture, overlay]
  \node[rectangle] at (11.6, -2.5)
   {\includegraphics[width=3cm]{cv-image}
  };
\end{tikzpicture}
...
\begin{itemize}
  ...
  \item {\small {\bf First authorship} on 11 published manuscripts}
...
\begin{itemize}
\item {
  \titlestyle {USMLE Step 2 CK} \datestyle{August 2016}
}
\item {
  \titlestyle {USMLE Step 2 CS} \datestyle{May 2016}
}
\item {
  \titlestyle {USMLE Step 1} \datestyle{October 2016}
}
\item {
...
{\footnotesize 
\begin{enumerate}
\item M.H.A. Jansen*, T. Lagerweij*, A.C.P. Sewing*, D.J. Vugts, D.G. van Vuurden, C.F.M. Molthoff, \namestyle{V. Caretti}, S.J.E. Veringa, N. Petersen, A.M. Carcaboso, D.P. Noske, W.P. Vandertop, P. Wesseling, G.A.M.S. van Dongen, G.J.L. Kaspers, E. Hulleman. Bevacizumab targeting diffuse intrinsic pontine glioma: results of 89Zr-bevacizumab PET imaging in brain tumor models. \emph{Mol Cancer Ther} (June 2016)
\item H.S. Venkatesh*, TB Johung*, \namestyle{V. Caretti*}, A. Noll*, Y. Tang, S. Nagaraja, E.M. Gibson, C.W. Mount, J. Polepalli, S.S.Mitra, P.J. Woo, R.C. Malenka, H. Vogel, M. Bredel, P. Mallick, M.Monje. Neuronal Activity Promotes Glioma Growth through Neuroligin-3 Secretion. \emph{Cell} (May 2015).161(4): 803–816.
\item A.C.P.Sewing*, \namestyle{V. Caretti*}, T. Lagerweij*, P. Schellen, M.H.A. Jansen, D.G. van Vuurden, S. Idema, C.F. Molthoff, W.P.Vandertop, G.J.L. Kaspers, D.P. Noske, E. Hulleman. Convection enhanced delivery of carmustine to the murine brainstem: A feasibility study. \emph{J Neurosci Methods} (Sep 2014). PMID:25263805
\item \namestyle{V. Caretti*}, M. Bugiani*, M Freret, P Schellen, M.H.A. Jansen, D.G. van Vuurden, G.J.L. Kaspers, PG Fisher, E Hulleman, P. Wesseling, H Vogel, M Monje. Subventricular spread of diffuse intrinsic pontine glioma. \emph{Acta Neuropathol} (Jun 2014). PMID:24929912
...
\item E. Giovannetti, Q.Wang, A. Avan, N. Funel, E. Galvani, T. Lagerweij, D. Chiasserini, J.H. Lee, \namestyle{V. Caretti}, A. van der Velde, U. Boggi, Y. Wang, E. Vasile, G.J .Peters, T. Wurdinger, G. Giaccone.. CYB5A role in pancreatic cancer prognosis and autophagy modulation.. \emph{JNCI} (Oct. 2013) PMID: 24301457
\item A. Avan*, \namestyle{V. Caretti*}, N. Funel*, E. Galvani, M. Maftouh, R.J. Honeywell, T. Lagerweij, O.V. Tellingen, D. Campani, D. Fuchs, H.M. Verheul, G.J .Schuurhuis, U. Boggi, G.J. Peters, T. Wrdinger, E. Giovannetti. Crizotinib inhibits metabolic inactivation of gemcitabine in c-Met-driven pancreatic carcinoma. \emph{Cancer Res} (Sept. 2013). PMID:24085787
\item \namestyle{V. Caretti*}, L. Hiddingh*, T. Lagerweij, P. Schellen, P.W. Koken, E. Hulleman, D. van Vuurden, W.P. Vandertop, G. Kaspers, D.P. Noske, T. Wurdinger. WEE1 Kinase Inhibition Enhances the Radiation Response of Diffuse Intrinsic Pontine Gliomas. \emph{Mol Cancer Ther} (Dec. 2012)
\item \namestyle{V. Caretti*}, L. Hiddingh*, T. Lagerweij, P. Schellen, P.W. Koken,E.Hulleman, D. van Vuurden, W.P. Vandertop, G. Kaspers, D.P. Noske, T. Wurdinger. WEE1 Kinase Inhibition Enhances the Radiation Response of Diffuse Intrinsic Pontine Gliomas. \emph{Mol Cancer Ther} (Dec. 2012). 12(2):141-50.
\item \namestyle{V. Caretti*}, M.H.A. Jansen*, D.G. van Vuurden, T. Lagerweij, M. Bugiani, I. Horsman, H. Wessels, P. van der Valk, J. Cloos, D.P. Noske, W.P. Vandertop, P. Wesseling, T. Wurdinger, E. Hulleman, G. Kaspers. Implementation of a Multi-Institutional Diffuse Intrinsic Pontine Glioma Autopsy Protocol and Characterization of a Primary Cell Culture. \emph{Neuropathol Appl Neurobiol} (July 2012)
...
\begin{itemize}
\item 2 Undergraduate, 1 Medical, and 2 PhD Students (Stanford) \datestyle{2013 -- 2016}
  \begin{itemize}
...
\section{AWARDS \\ FOR \\ INTERNATIONAL \\ INTERNSHIPS}
\begin{itemize}
...
\section{SYMPOSIA \\ AND \\ CONGRESSES}
\begin{itemize}
\item {
  Oral Presentations:
  \begin{itemize}
...
\item {
  ...
  \emph{Artist-Editor} for the books:
  \begin{itemize}
  \item \emph{'Pachamama'} where her paintings were also published. \datestyle{1999}
...
\section{PROFESSIONAL THEATER TRAINING}
\begin{itemize}
